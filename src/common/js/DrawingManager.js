...
var BMAP_DRAWING_MARKER    = window.BMAP_DRAWING_MARKER="marker",     // 鼠标画点模式
    BMAP_DRAWING_POLYLINE  = window.BMAP_DRAWING_POLYLINE="polyline",   // 鼠标画线模式
    BMAP_DRAWING_CIRCLE    = window.BMAP_DRAWING_CIRCLE="circle",     // 鼠标画圆模式
    BMAP_DRAWING_RECTANGLE = window.BMAP_DRAWING_RECTANGLE="rectangle",  // 鼠标画矩形模式
    BMAP_DRAWING_POLYGON   = window.BMAP_DRAWING_POLYGON="polygon";    // 鼠标画多边形模式
/**
 * 定义常量, 绘制的模式
...
(function() {
    ...
    window.DrawingManager=BMapLib.DrawingManager = function(map, opts){
            if (!map) {
                return;
            }
            instances.push(this);
